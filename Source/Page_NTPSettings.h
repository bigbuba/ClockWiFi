...
<tr><td align="right">Обновлять каждые:</td><td><input type="text" id="update" name="update" size="8" maxlength="6" value=""> секунд (0=запрет)</td></tr>
<tr><td align="right">Час. пояс</td><td>
